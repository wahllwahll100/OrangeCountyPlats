...
"""
            ...
            # ── Step 2: Embed OCPA Property Card (user's browser loads it) ──
            st.markdown("#### 📄 OCPA Property Card")
            st.caption("This loads directly in your browser — OCPA allows it. Find the **Plat Book/Page** under Location Information or Legal Description.")
            st.components.v1.iframe(ocpa_card_url, height=500, scrolling=True)
...
4. FOR PLAT BOOK/PAGE: The plat book and page are visible on the OCPA Property Card (embedded above on the page). Tell the user to scroll down in the embedded OCPA card above to find "Plat Book" and "Plat Page" under the property details. Once they have those numbers, they should search the Comptroller's Official Records (also embedded below) by Book/Page to view and download the actual plat PDF for free.
...
Be direct, factual, and concise. Present data in a clear format. The engineer reading this needs actionable info, not tutorials."""
            ...
            # ── Step 5: Embedded Comptroller for plat PDF retrieval ──
            st.markdown("#### 📑 Orange County Comptroller – Official Records")
            st.caption("Use the Plat Book/Page from the OCPA card above → search here by Book/Page → view/download the plat PDF free.")
            st.components.v1.iframe(comptroller_url, height=600, scrolling=True)
