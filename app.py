...
Be direct, factual, and concise. Present data in a clear format. The engineer reading this needs actionable info, not tutorials."""
            ...
            # ── Step 5: Comptroller link for plat PDF retrieval ──
            st.markdown(f"""
            <div class="info-card" style="border-left:4px solid #0f4c75;">
                <h3>📑 Orange County Comptroller – Plat PDF Download</h3>
                <div class="role">
                    <strong>How to get the plat PDF (takes 30 seconds):</strong><br>
                    1. Open the OCPA Property Card above and find the <strong>Plat Book</strong> and <strong>Plat Page</strong> numbers<br>
                    2. Click the Comptroller link below → Accept the disclaimer<br>
                    3. Select search type: <strong>"Book/Page"</strong><br>
                    4. Enter the Book and Page numbers → Search<br>
                    5. Click the result → <strong>View the plat PDF</strong> → Print or save<br>
                    <br>
                    Plat documents are free to view and print from the Comptroller's website.
                </div>
                <div style="margin-top:10px; display:flex; gap:10px; flex-wrap:wrap;">
                    <a href="{comptroller_url}" target="_blank" 
                       style="display:inline-block; background:#0f4c75; color:white; padding:10px 24px; border-radius:6px; font-weight:700; text-decoration:none; font-size:14px;">
                        📑 Open Comptroller Records Search →
                    </a>
                    <a href="{ocpa_card_url}" target="_blank" 
                       style="display:inline-block; background:#f7a325; color:#0c1b2a; padding:10px 24px; border-radius:6px; font-weight:700; text-decoration:none; font-size:14px;">
                        📄 Open OCPA Card (for Plat Book/Page) →
                    </a>
                </div>
            </div>
            """, unsafe_allow_html=True)
