...
if query_lat and query_lon:
    ...
    if parcels:
        ...
        with st.expander("🔧 Debug: Endpoints Attempted"):
            ...
            test_url = f"{_STATEWIDE_PARCELS_URL}?geometry={query_lon},{query_lat}&geometryType=esriGeometryPoint&spatialRel=esriSpatialRelIntersects&inSR=4326&outSR=4326&where=1=1&outFields=PARCEL_ID,CO_NO,OWN_NAME,PHY_ADDR1&returnGeometry=false&f=json"
