...
_CONTACTS_FALLBACK = {
  "municipal_offices": [
    ...
    {"name": "Orange County Property Appraiser", "role": "Parcel data, ownership records, property values", "phone": "(407) 836-5044", "email": "", "address": "200 S. Orange Ave., Suite 1700, Orlando, FL 32801", "url": "https://www.ocpafl.org/"},
...
_RESOURCES_FALLBACK = {
  "gis_and_mapping": [
    ...
    {"name": "Orange County Property Appraiser – Property Search", "url": "https://www.ocpafl.org/Searches/ParcelSearch.aspx", "description": "Search by address, owner, or parcel ID for ownership, legal description, assessed values"},
    {"name": "Orange County Property Appraiser – Interactive Map", "url": "https://maps.ocpafl.org/", "description": "Visual parcel map with ownership data, building footprints, aerials"},
    {"name": "Orange County Comptroller – Official Records Search", "url": "https://www.occompt.com/services/official-records/search-official-records/", "description": "Search recorded plats, deeds, easements, liens, declarations of covenants (HOA docs)"},
  ...
  "plats_and_surveys": [
    {"name": "Orange County Comptroller – Plat Book Search", "url": "https://www.occompt.com/services/official-records/search-official-records/", "description": "Search and view recorded subdivision plats by plat book/page or subdivision name"},
    {"name": "Orange County Property Appraiser – Plat Map", "url": "https://www.ocpafl.org/", "description": "Parcel maps with plat book/page references linked to recorded plats"},
